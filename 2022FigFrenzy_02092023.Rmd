...
popVpart <- Figs %>% #Data for State population vs. ACP participation
  select(Totals.State, '2022.parts', population, `population/participants`, `growth rate`)
...
##if the axes are flipped then the abline equation becomes y=0.0311x+29.786
popVpart_grf
cor.test(popVpart2$`2022.parts`, popVpart2$pop2)
mult_popVpart <- lm(`2022.parts` ~ pop2 + `growth rate`, data = popVpart2)
```
